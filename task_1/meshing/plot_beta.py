...
ax[0].scatter(iter_x,error1_x,label="error1",s=5)
ax[0].scatter(iter_x,error2_x,label="error2",s=5)
...
ax[1].scatter(iter_y,error1_y,label="error1",s=5)
ax[1].scatter(iter_y,error2_y,label="error2",s=5)
